            ...
            <form action="index.php?url=cad_tipo/acao/crudAdm" method="post">
             ...
             <input type="hidden" name="id_naj" value="<?=$reg->id_naj?>">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nome_NAJ" placeholder="NAJ" name="txtNomeNaj" value="<?=$reg->nome?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="endereco_NAJ" placeholder="Endereço" name="txtEnderecoNaj" value="<?=$reg->endereco?>">
              </div>
              <div class="form-group">
