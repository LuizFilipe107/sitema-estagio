...
<center> <h2>CADASTRAR - <?=$reg->ultimo?></h2></center>

<div class="container">

    <form class="form-horizontal" method="post" action="index.php?url=cadastrar/acoes/crud_cadastro" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="endereco">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type="hidden" name="id_cad" value="<?=$reg->ultimo?>">
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select id="" name="curso_inst" class="form-control">
                                            <?php  while($reg = mysqli_fetch_object($dados5)){ ?>
                                                <option value="<?=$reg->id_curso?>"><?=$reg->descricao?></option>
                                            <?php  } ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <select id="" name="txtNomeDefensoria" class="form-control">
                                            <?php  while($reg2 = mysqli_fetch_object($dados2)){ ?>
                                                <option value="<?=$reg2->id_defensoria?>"><?=$reg2->nome?></option>
                                            <?php  } ?>
                                        </select>
                                    </div>
                                </div>
