...
--
-- Host: 127.0.0.1
-- Generation Time: 21-Mar-2018 às 19:58
...
INSERT INTO `tb_cadastro` (`orgao`, `id_cad`, `id_situacao`, `id_tipo_estagio`, `nome`, `matricula`, `nacionalidade`, `estado_civil`, `naturalidade`, `data_nascimento`, `filiacao`, `identidade`, `CPF`, `OAB`, `titulo_eleitor`, `zona`, `secao`, `data_cadastro`, `data_desligamento`, `sexo`, `email`) VALUES
...
INSERT INTO `tb_remocao` (`id_remocao`, `id_naj`, `id_defensoria`, `id_cad`, `data_rem`, `id_najNova`, `id_defensoriaNova`, `id_tipo_estagio`, `obs`) VALUES
(29, 48, 11, 10, '0000-00-00', 47, 14, 0, ''),
(28, 47, 11, 2, '2017-02-03', 48, 15, 0, ''),
(30, 48, 14, 13, '15/12/2017', 47, 15, 0, ''),
(31, 48, 14, 15, '15/12/2017', 47, 14, 0, ''),
(32, 47, 14, 15, '15/12/2017', 47, 15, 0, ''),
(33, 47, 15, 12, '18/12/2017', 48, 11, 0, ''),
(34, 47, 11, 14, '18/12/2017', 48, 14, 0, ''),
(35, 47, 14, 10, '18/12/2017', 48, 15, 0, ''),
(36, 48, 15, 10, '18/12/2017', 47, 14, 0, ''),
(37, 48, 14, 12, '18/12/2017', 48, 14, 0, ''),
(38, 48, 15, 2, '18/12/2017', 48, 14, 0, ''),
(39, 48, 14, 14, '18/12/2017', 47, 11, 0, '');
...
(1, 3, 'ADMINISTRADOR', 'c5a90d23e7908e6454b6c52e52aabc77', 'admin', 'c5a90d23e7908e6454b6c52e52aabc77');
...
--
ALTER TABLE `tb_end`
  MODIFY `id_end` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `tb_instituicao`
  MODIFY `id_instituicao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

--
-- AUTO_INCREMENT for table `tb_lotacao`
--
ALTER TABLE `tb_lotacao`
  MODIFY `id_lotacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `tb_telefone`
  MODIFY `id_telefone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT for table `tb_tipo_doc`
--
ALTER TABLE `tb_tipo_doc`
  MODIFY `id_tipo_doc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
