...
<div class="container">
				<a href="index.php?url=pre_cadastro/pre_cadastro"><button type="button" class="btn btn-success">Cadastrar</button><br><br></a> <center><h3>Lista de Estagiários Cadastrados</h3></center>
<hr>
