...
<body>
    ...
    <div class="container">
        ...
        <div class="right"><a href="javascript:history.back()"><button  class="btn btn-primary center-block" style="font-size: 15px; float: left;" ><i class="fa fa-chevron-left" aria-hidden="true"></i> Voltar</button></a></div>
        <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select id="nacionalidade" name="nacionalidade" class="form-control"  style="text-transform:uppercase;" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <?php $data= date("d/m/Y")?>
                                    <input name="data_cadastro" type="text" class="form-control" id="data_cadastro" value="<?=$data?>"
                                           >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <select id="" name="txtTipoEstagio" class="form-control">
                                        <?php  while($reg = mysqli_fetch_object($dados1)){ ?>
                                            <option value="<?=$reg->id_tipo_estagio?>"><?=$reg->tipo?></option>
                                        <?php  } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <select id="" name="txtSituacaoEstagio" class="form-control">
                                        <?php  while($reg2 = mysqli_fetch_object($dados)){ ?>
                                            <option value="<?=$reg2->id_situacao?>"><?=$reg2->situacao?></option>
                                        <?php  } ?>
                                    </select>
                                </div>
                            </div>
