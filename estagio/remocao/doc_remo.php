...
<fieldset>
  ...
  <div class="container">
  <div class="row">
    <CENTER><h3>REMOÇÃO</h3></CENTER><br>
  </div>
</div>
 ...
 <table class="table table-bordered table-hover" style="width: 100%" align="center" style="border:0;">
                  <tbody>
                     ...
                     <tr>
                      <td>
                        MEMO/Nº:<input style="border: 0;" id="Telefone" name="MEMO" class="form-control input-md" placeholder="" required="" type="text" >
                      </td>
                      <td>
                       <?php $data= date("d/m/Y")?>
                        Brasília:<br><input style="border: 0;" id="fname" name="fname" required="required" placeholder="" type="text" class="form-control input-md" value="<?=$data?>" >
 ...
 <table class="table table-bordered table-hover" style="width: 100%" align="center" style="border:0;">
                  <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                      <td>
                        Nome:<input style="border: 0;" id="nome" name="MEMO" class="form-control input-md" placeholder="" required="" type="text" value="<?=$reg->nome?>">
                      </td>
                      
                      <td>
                       Matrícula:<input style="border: 0;" id="matricula" name="Nº" class="form-control input-md" placeholder="" required="" type="text" value="<?=$reg->matricula?>">
                      </td>
                    ...
                    <tr>
                      ...
                      <center>
                       Atenciosamente, <br> 
                        <input type="text" name="fname" style="border: 0;" align="center" ><br> 
